...
Revision ID: f0253be5bf60
Revises: 
Create Date: 2024-08-30 02:51:21.884288
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_articles_category"), "articles", ["category"], unique=True)
